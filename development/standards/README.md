...
interactive, navigable **vocabulary matrix** (labelers × slots, the file `/vocaby` fills) is [`vocabulary/index.html`](vocabulary/index.html) (renamed 2026-08-03 from `flove-tiers-matrix.html`, moved 2026-09-08 to `vocabulary/`).
