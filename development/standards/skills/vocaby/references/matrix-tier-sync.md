...
`development/standards/vocabulary/index.html` — renamed 2026-08-03 from the old
`flove-tiers-matrix.html`, moved to `vocabulary/` 2026-09-08; its `<title>` is "flove · standards matrix". It is **not** one
