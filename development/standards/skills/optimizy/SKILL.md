...
| vocaby | class/id/label names match the words the UI shows (spot-grep a couple against `vocabulary/index.html` slots) → skip (or only rename the drift) |
