...
description: >-
  ...
  Built flove-first; anything that would diverge from the shared standard is surfaced,
...
| **Demos index** | `apps/index.html` | the `#mark-<app>` **symbol** (drives app-bar, grid tile, cube icon, logo slide) |
