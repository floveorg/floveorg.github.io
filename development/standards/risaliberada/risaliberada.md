...
**Diagramas:** fuentes `.mmd` versionadas en `mermaid/` (risaliberada-v1-thread · risaliberada-v1-flow · risaliberada-v1-subdomain · liberada-v2-flow · risa-v2-subdomain-request · risa-v2-subdomain-create · flove-v2-thread) — renders `.png`/`.svg` centralizados en `central/shared/media/images/development/`
