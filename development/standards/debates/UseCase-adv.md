...
| 12 | Load defaults | types: vision/arch/trust/data/integration, batch: 5, per-type: 5 | Defaults loaded |
...
## Phase 3 — Perspectives: Types (steps 21–48)

| # | What questy does | HTML form | Console prompt |
|---|-----------------|-----------|----------------|
| 21 | Show KISS types | [vision] [arch] [trust] [data] [integration] | `Q8: Types? [1]vision [2]arch [3]trust [4]data [5]integration` |
