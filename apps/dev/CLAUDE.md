...
- **Mandatory frontend contract** → [`standards/contract.md`](standards/contract.md)
- **Frontend patterns catalogue (§13)** → [`standards/frontend.md`](standards/frontend.md)
- **Standards index / matrix** → [`standards/README.md`](standards/README.md)
- **Per-app adoption checklist (§14)** → [`standards/adoption.md`](standards/adoption.md)
...
`standards/frontend.md §13.x` first. `ray-*`/`bot-*` are the **old** vocabulary
